...
const RegisterStudent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from("students").insert({
      ...
      registration_number: "", // auto-generated by DB trigger
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">Student ID will be auto-generated by the system.</p>
      <Card>
